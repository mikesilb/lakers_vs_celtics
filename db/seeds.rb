...
Game.create!(date: '2010-06-03', score: "Celtics 89, Lakers 102", nbafinal_id: 25)
Game.create!(date: '2010-06-06', score: "Celtics 103, Lakers 94", nbafinal_id: 25)
Game.create!(date: '2010-06-08', score: "Lakers 91, Celtics 84", nbafinal_id: 25)
Game.create!(date: '2010-06-10', score: "Lakers 89, Celtics 96", nbafinal_id: 25)
Game.create!(date: '2010-06-13', score: "Lakers 86, Celtics 92", nbafinal_id: 25)
Game.create!(date: '2010-06-15', score: "Celtics 67, Lakers 89", nbafinal_id: 25)
Game.create!(date: '2010-06-17', score: "Celtics 79, Lakers 83", nbafinal_id: 25)
Game.create!(date: '2008-06-05', score: "Lakers 88, Celtics 98", nbafinal_id: 14)
Game.create!(date: '2008-06-08', score: "Lakers 102, Celtics 108", nbafinal_id: 14)
Game.create!(date: '2008-06-10', score: "Celtics 81, Lakers 87", nbafinal_id: 14)
Game.create!(date: '2008-06-12', score: "Celtics 97, Lakers 91", nbafinal_id: 14)
Game.create!(date: '2008-06-15', score: "Celtics 98, Lakers 103", nbafinal_id: 14)
Game.create!(date: '2008-06-17', score: "Lakers 92, Celtics 131", nbafinal_id: 14)
